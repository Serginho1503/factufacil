    ...
    $.fn.formToWizard = function( options, cmdParam1 ) {
        ...
        if( typeof options !== 'string' ) {
            ...
            steps.each(function(i) {
                ...
                if( options.showProgress ) {
                    if( options.showStepNo ) // LE QUITE EL  #
        ...
        function createPrevButton(i) {
            var stepName = "step" + i;
            $("#" + stepName + "commands").append("<a href='#' id='" + stepName + "Prev' class='prev_'>" + options.prevBtnName + "</a>");
        ...
        function createNextButton(i) {
            var stepName = "step" + i;
            $("#" + stepName + "commands").append("<a href='#' id='" + stepName + "Next' class='next_'>" + options.nextBtnName + "</a>");
