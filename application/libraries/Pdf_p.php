...
#----------------------------------------------------------------------------------------------------------------------------------
	...
	function Header(){
	    ...
	    if ($this->sucursal->logo_sucursal){    
			...
			$this->Image($file_name,10,10,40,17);
		}
		/*$this->Image('public/img/quitoledbn.jpg',10,10,50,14);*/
        $this->Line(12,28,196,28);
        $this->SetFont('Arial','B',10);

      $this->SetXY(50,8);
      $this->MultiCell(110,4,utf8_decode($this->empresa->nom_emp).'  RUC: '.utf8_decode($this->empresa->ruc_emp) ,0,'C');
      $this->SetXY(50,13);
...
/*        $this->text(80, 15, utf8_decode('AV. COLÓN OEE1-80 Y 10 DE AGOSTO'));
        ...
        $this->text(167, 19, 'PROFORMA');
        $this->SetFont('Arial','B',9);
        $nroprof = $this->encprof->nro_proforma;
        $this->text(170, 24, utf8_decode('Nº '.$nroprof));
