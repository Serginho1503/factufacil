...
<div id = "contenido_area" class="col-md-6">
    <div class="box box-danger">
        ...
        <form id="formDEL" name="formDEL" method='POST' action="<?php echo base_url('area/eliminar');?>" onSubmit='return false' >
            <div class="box-body">
                <div class="row">
                ...
                <div class="form-group col-md-12">
                    ...
                    <input type="text" class="form-control validate[required]" name="txt_nomarea" id="txt_nomarea" disabled="" value="<?php if(@$area != NULL){ print @$area->nom_area; }?>" >
                </div>
