...
<div id = "contenido_mese" class="col-md-12">
    <div class="box box-danger">
        <div class="box-header with-border">
          <h3 class="box-title"><i class="fa fa-user"></i> Nota de Credito </h3>
        </div>
        
        <form id="formID" name="formID" method='POST' action="<?php echo base_url('Notacredito/imprimir');?>" onSubmit='return false' >
