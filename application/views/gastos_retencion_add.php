...
<!--                             <tr>
                              <th style="width: 50%" class="text-right">Monto IVA</th>
                              <td><input style="width: 100px"  type="text" class="form-control text-center" id="txt_montoiva" name="txt_montoiva" value="<?php if(@$retencion != NULL){ print @$retencion->monto_iva;} else {print round(@$subtotalconiva * 0.12,2);}?>" readonly></td>
                            </tr>   -->                          
