...
<div class="content-wrapper">
    ...
    <div id="codbar" class="form-group col-md-12">
        ...
        <input type="text" class="form-control" name="txt_codbar" id="txt_codbar" placeholder="Código de Barra" value="<?php if(@$pro != NULL){ echo @$pro->pro_codigobarra; }?>">
    </div>
    ...
    <script type="text/javascript">
        function generarbarcode() {
            ...
            var product_name = $("#txt_nompro").val(); // Obtenemos el nombre del producto
            JsBarcode("#barcode", txt_codbar);
            $("#product_name").text(product_name); // Mostramos el nombre del producto
            $("#print").show();
        }
    ...
    <div id="codaux" class="form-group col-md-12">
        ...
        <input type="text" class="form-control" name="txt_codaux" id="txt_codaux" placeholder="Código Auxiliar" value="<?php if(@$pro != NULL){ echo @$pro->pro_codigoauxiliar; }?>">
    </div>

    <!-- Nombre del Producto-->
    <div id="nompro" class="form-group col-md-12">
        <label for="lb_nompro">Nombre</label>
        <input type="text" class="form-control validate[required]" name="txt_nompro" id="txt_nompro" placeholder="Nombre del Producto" value="<?php if(@$pro != NULL){ echo @$pro->pro_nombre; }?>">
    </div>
  ...
  <!-- /.content-wrapper -->
                ...
                <!-- Agrega estilos CSS para el contenedor del código de barras -->
<style>
    #print {
        width: 5cm; /* Ancho de la etiqueta */
        height: 3cm; /* Alto de la etiqueta */
        display: flex;
        justify-content: center; /* Centra horizontalmente */
        align-items: center; /* Centra verticalmente */
        border: 1px solid black; /* Añade un borde para visualización */
        margin: 0 auto; /* Centra la etiqueta horizontalmente */
    }

    #barcode {
        width: 100%; /* Asegura que el código de barras ocupe todo el espacio del contenedor */
        height: auto; /* Permite que la altura del código de barras se ajuste automáticamente */
    }
</style>

<!-- Lugar donde se muestra el código de barras -->
<div id="print">
    <svg id="barcode"></svg>
</div>
...
<style type="text/css" media="print">
    @page {
        size: 5cm 3cm; /* Tamaño de la página de impresión en centímetros */
        margin: 0; /* Elimina los márgenes predeterminados */
    }

    body {
        margin: 0; /* Elimina los márgenes del cuerpo del documento */
    }

    #print {
        width: 5cm; /* Ancho de la etiqueta */
        height: 3cm; /* Alto de la etiqueta */
        overflow: hidden; /* Oculta cualquier contenido que exceda el tamaño de la etiqueta */
    ...
    #barcode {
        width: 100%; /* Asegura que el código de barras ocupe todo el espacio del contenedor */
        height: auto; /* Permite que la altura del código de barras se ajuste automáticamente */
        position: absolute; /* Permite posicionar el código de barras dentro del contenedor */
        top: 0; /* Alinea el código de barras en la parte superior del contenedor */
        left: 0; /* Alinea el código de barras en la parte izquierda del contenedor */
    }
</style>
