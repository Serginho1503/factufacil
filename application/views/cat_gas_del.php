...
<div id = "contenido_cat" class="col-md-6">
    <div class="box box-danger">
        ...
        <form id="formDEL" name="formDEL" method='POST' action="<?php echo base_url('catgastos/eliminar');?>" onSubmit='return false' >
        <div class="box-body">
            <div class="row">
            ...
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control validate[required]" name="txt_cat" id="txt_cat" disabled="" value="<?php if(@$cat != NULL){ print @$cat->nom_cat_gas; }?>" >
            </div>
