...
<script type="text/javascript">
    $( document ).ready(function() {
        ...
        var pos = contenido.indexOf("IMPRESION");
...
<div id = "contenido_mese" class="col-md-12">
    <div class="box box-danger">
        <div class="box-header with-border">
          <h3 class="box-title"><i class="fa fa-user"></i> Comanda </h3>
        </div>
        
        <form id="formID" name="formID" method='POST' action="<?php echo base_url('Pedido/imprimircomanda');?>" onSubmit='return false' >
