...
<script type='text/javascript' language='javascript'>
  ...
  $( document ).ready(function() {
    ...
    $("#imprimir-ride").attr("disabled", true);
...
*/
      ...
      $(document).on('dblclick', '.factaddpro', function(){
        ...
        var pago = $("#imprimir-ride").attr("name");
    		if(pago == 0){
          if (id) {
          $.ajax({
            type: "POST",
...
*/
                      ...
                      if ((parseFloat(montototal) > 0) && ((forpago != "Contado") || 
                        ...
                        $.ajax({
                          ...
                          success: function(json) {
                            ...
                            $("#imprimir-ride").attr("disabled", false);
                            $("#pagar").attr("disabled", true);
                            $("#pagar").css("display", "none");
    ...
    $(document).on('click', '#imprimir', function(){
      ...
      if (imprimepdf == 1) {
        ...
        $(document).on('click', '#imprimir-ride', function(){
      var id = $(this).attr('name');
      var idforma = $("#cmb_tipfac option:selected").val();
              ...
              <div class="form-group col-md-12" style="margin-bottom: 5px; padding-left: 0px;">
               ...
               <div class="col-md-9">
                <div class="input-group date">
                    <input type="text" class="form-control text-center validate[required]" id="fecha" name="fecha" value="<?php print  date("d/m/Y");?>" style="width: 90px;" >
                </div>    
               </div> 
              </div>
            </div>
                            ...
                            <tbody>                                                        
                              ...
                              ?>
                                <tr class="factaddpro idpropre" style="background-color: <?php if ($p->existencia <= $p->min and $p->existencia > 0 and $p->preparado == 0 && $p->pro_esservicio == 0) { print '#FFB40F'; } 
                                  ...
                                  <td class="text-right">
                                    <?php echo number_format($p->pro_precioventa * (1 + $tarifaiva), 2); ?>
                                  </td>
                                  <td class="text-right">
              ...
              <div class="col-md-7" style="padding-right: 0px; padding-left: 0px;">
                ...
                <div class="box">
                  <div class="box-header with-border">
                    ...
                    <div class="col-md-3">
                      <input type="text" class="form-control col-md-3 codbar text-center" name="txt_codbar" id="txt_codbar" placeholder="Codigo de Barra" value="" autofocus>  
                    </div>
                        ...
                        <table class="table table-clear calmonto" >
                          <tbody>
                           <tr>
                            ...
                            ?>
                            <tr>
                              <td class="text-left"><strong>Subtotal IVA 15 %</strong></td>
                            ...
                            <?php } ?>                                                      
                            <tr>
                              <td class="text-left"><strong>Subtotal con Descuento IVA 15 %</strong></td>
                            ...
                            <tr>
                              <td class="text-left"><strong>IVA (15%)</strong></td>
                  ...
                  <div class="box-footer ">
                    ...
                    <div class="col-md-6 text-right">
                      ...
                      <button id="imprimir-ride" type="button" class="btn btn-sm btn-primary btn-grad" name="0" >
                        <i class="fa fa-print"></i> Imp. RIDE
                      </button>   
