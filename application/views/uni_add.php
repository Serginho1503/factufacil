...
<div id = "contenido_cat" class="col-md-6">
    <div class="box box-danger">
        ...
        <form id="formID" name="formID" method='POST' action="<?php echo base_url('unidades/agregar');?>" onSubmit='return false' >
        <div class="box-body">
            <div class="row">
            ...
            <div class="form-group col-md-12">
                ...
                <input type="text" class="form-control validate[required]" name="txt_uni" id="txt_uni" placeholder="Unidad de Medida" value="<?php if(@$uni != NULL){ print @$uni->descripcion; }?>" >
            </div>
            <!-- Nombre Corto de la Unidad de Medida -->
            <div class="form-group col-md-6">
                <label for="lb_nom_cor">Nombre Corto</label>
                <input type="text" class="form-control validate[required]" name="txt_nom_cor" id="txt_nom_cor" placeholder="Nombre Corto" value="<?php if(@$uni != NULL){ print @$uni->nombrecorto; }?>" >
            </div>
            </div>
        </div>
        <!-- /.box-body -->
